...
'BSPWM_SOCKET'::
	The path of the socket used for the communication between *bspc* and *bspwm*. If it isn't defined, then the following path is used: '/data/data/com.termux/files/usr/tmp/bspwm<host_name>_<display_number>_<screen_number>-socket'.
